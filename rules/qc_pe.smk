...
rule fastqc:
    ...
    output:
        html1="qc/fastqc/untrimmed_{sample}-R1.html",
        zip1="qc/fastqc/untrimmed_{sample}-R1_fastqc.zip"
        html2="qc/fastqc/untrimmed_{sample}-R1.html",
        zip2="qc/fastqc/untrimmed_{sample}-R1_fastqc.zip"
